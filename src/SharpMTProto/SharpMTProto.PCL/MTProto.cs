...
//     Generated at 12/13/2013 00:40:56
//
...
namespace SharpMTProto
{
    ...
    {
        [TLProperty(1)]
        public SharpTL.BaseTypes.Int128 nonce { get; set; }

        [TLProperty(2)]
        public SharpTL.BaseTypes.Int128 server_nonce { get; set; }

        [TLProperty(3)]
        public System.Byte[] pq { get; set; }

        [TLProperty(4)]
        public System.Collections.Generic.List<long> server_public_key_fingerprints { get; set; }
    ...
    public partial class p_q_inner_data : P_Q_inner_data
    {
        ...
        [TLProperty(6)]
        public SharpTL.BaseTypes.Int256 new_nonce { get; set; }
    ...
    public partial class server_DH_params_fail : Server_DH_Params
    {
        ...
        [TLProperty(3)]
        public SharpTL.BaseTypes.Int128 new_nonce_hash { get; set; }
    ...
    public partial class dh_gen_ok : Set_client_DH_params_answer
    {
        ...
        [TLProperty(3)]
        public SharpTL.BaseTypes.Int128 new_nonce_hash1 { get; set; }
    ...
    public partial class dh_gen_retry : Set_client_DH_params_answer
    {
        ...
        [TLProperty(3)]
        public SharpTL.BaseTypes.Int128 new_nonce_hash2 { get; set; }
    ...
    public partial class dh_gen_fail : Set_client_DH_params_answer
    {
        ...
        [TLProperty(3)]
        public SharpTL.BaseTypes.Int128 new_nonce_hash3 { get; set; }
    ...
    [TLType(typeof(resPQ))]
    public abstract partial class ResPQ
    {
    }

    [TLType(typeof(p_q_inner_data))]
    public abstract partial class P_Q_inner_data
    {
    }

    [TLType(typeof(server_DH_params_fail), typeof(server_DH_params_ok))]
    public abstract partial class Server_DH_Params
    {
    }

    [TLType(typeof(server_DH_inner_data))]
    public abstract partial class Server_DH_inner_data
    {
    }

    [TLType(typeof(client_DH_inner_data))]
    public abstract partial class Client_DH_Inner_Data
    {
    }

    [TLType(typeof(dh_gen_ok), typeof(dh_gen_retry), typeof(dh_gen_fail))]
    public abstract partial class Set_client_DH_params_answer
    {
    }

    [TLType(typeof(rpc_result))]
    public abstract partial class RpcResult
    {
    }

    [TLType(typeof(rpc_error))]
    public abstract partial class RpcError
    {
    }

    [TLType(typeof(rpc_answer_unknown), typeof(rpc_answer_dropped_running), typeof(rpc_answer_dropped))]
    public abstract partial class RpcDropAnswer
    {
    }

    [TLType(typeof(future_salt))]
    public abstract partial class FutureSalt
    {
    }

    [TLType(typeof(future_salts))]
    public abstract partial class FutureSalts
    {
    }

    [TLType(typeof(pong))]
    public abstract partial class Pong
    {
    }

    [TLType(typeof(destroy_session_ok), typeof(destroy_session_none))]
    public abstract partial class DestroySessionRes
    {
    }

    [TLType(typeof(new_session_created))]
    public abstract partial class NewSession
    {
    }

    [TLType(typeof(msg_container))]
    public abstract partial class MessageContainer
    {
    }
    ...
    public abstract partial class MessageCopy
    {
    }
    ...
    public abstract partial class MsgsAck
    {
    }

    [TLType(typeof(bad_msg_notification), typeof(bad_server_salt))]
    public abstract partial class BadMsgNotification
    {
    }

    [TLType(typeof(msg_resend_req))]
    public abstract partial class MsgResendReq
    {
    }

    [TLType(typeof(msgs_state_req))]
    public abstract partial class MsgsStateReq
    {
    }

    [TLType(typeof(msgs_state_info))]
    public abstract partial class MsgsStateInfo
    {
    }

    [TLType(typeof(msgs_all_info))]
    public abstract partial class MsgsAllInfo
    {
    }

    [TLType(typeof(msg_detailed_info), typeof(msg_new_detailed_info))]
    public abstract partial class MsgDetailedInfo
    {
    }
...
//        HttpWait http_wait(http_wait args);
    }
}
